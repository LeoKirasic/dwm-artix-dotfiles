...
static char *colors[][3]        = {
	...
	[SchemeSel]  = { color9,        background,     color9      },
	[SchemeUrg]  = { color6,        background,     color6      },
};
...
/* --------------- defaults -------------- */
#define APP_BROWSER             "chromium"
#define APP_BROWSER_            "chromium --private-window"
#define APP_MENU                "rofi -show run"
...
static const char *dmenucmd[] = { APP_TERMINAL, "-m", dmenumon, "-fn", dmenufont, "-nb", NULL };
...
static Key keys[]               = {
	...
	{ MODKEY|ShiftMask,             XK_q,       killclient,           {1} },
